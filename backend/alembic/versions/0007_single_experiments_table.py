...
def downgrade() -> None:
    ...
    op.add_column('laboratory_experiments', sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False))
    ...
    op.add_column('computational_experiments', sa.Column('created_at', postgresql.TIMESTAMP(),
                                                         server_default=sa.text("timezone('utc'::text, now())"),
                                                         autoincrement=False, nullable=False))
    op.add_column('computational_experiments', sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False))
