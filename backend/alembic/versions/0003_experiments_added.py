...
def upgrade() -> None:
    ...
    DO $$
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'schemakind') THEN
            CREATE TYPE schemakind AS ENUM ('INPUT', 'OUTPUT', 'PARAMETERS', 'CONTEXT');
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'experimentkind') THEN
            CREATE TYPE experimentkind AS ENUM ('LABORATORY', 'COMPUTATIONAL');
        END IF;
    END
    $$;
    """)
    ...
    op.create_table('schemas',
                    sa.Column('type',
                              sa.Enum('INPUT', 'OUTPUT', 'PARAMETERS', 'CONTEXT', name='schemakind').with_variant(
                                  postgresql.ENUM(
                                      'INPUT',
                                      'OUTPUT',
                                      'PARAMETERS',
    ...
    op.create_table('computational_experiment_templates',
                    sa.Column('input_schema_id', sa.BigInteger(), nullable=False),
                    sa.Column('output_schema_id', sa.BigInteger(), nullable=False),
                    sa.Column('parameters_schema_id', sa.BigInteger(), nullable=False),
                    sa.Column('context_schema_id', sa.BigInteger(), nullable=False),
                    sa.Column('id', sa.BigInteger(), server_default=sa.Identity(always=False), nullable=False),
                    sa.ForeignKeyConstraint(['context_schema_id'], ['schemas.id'], name=op.f(
                        'fk_computational_experiment_templates_context_schema_id_schemas')),
                    sa.ForeignKeyConstraint(['input_schema_id'], ['schemas.id'],
                                            name=op.f('fk_computational_experiment_templates_input_schema_id_schemas')),
                    sa.ForeignKeyConstraint(['output_schema_id'], ['schemas.id'], name=op.f(
                        'fk_computational_experiment_templates_output_schema_id_schemas')),
                    sa.ForeignKeyConstraint(['parameters_schema_id'], ['schemas.id'], name=op.f(
                        'fk_computational_experiment_templates_parameters_schema_id_schemas')),
    ...
    op.create_table('measurements',
                    ...
                    sa.Column('column', sa.BigInteger(), nullable=False),
    ...
    op.create_table('computational_experiment_datas',
                    ...
                    sa.ForeignKeyConstraint(['context_schema_id'], ['schemas.id'],
                                            name=op.f('fk_computational_experiment_datas_context_schema_id_schemas')),
                    sa.ForeignKeyConstraint(['experiment_id'], ['computational_experiments.id'], name=op.f(
                        'fk_computational_experiment_datas_experiment_id_computational_experiments')),
                    sa.ForeignKeyConstraint(['input_schema_id'], ['schemas.id'],
                                            name=op.f('fk_computational_experiment_datas_input_schema_id_schemas')),
                    sa.ForeignKeyConstraint(['output_schema_id'], ['schemas.id'],
                                            name=op.f('fk_computational_experiment_datas_output_schema_id_schemas')),
                    sa.ForeignKeyConstraint(['parameters_schema_id'], ['schemas.id'], name=op.f(
                        'fk_computational_experiment_datas_parameters_schema_id_schemas')),
